...
ggplot(box.m, aes(variable,value,fill=variable)) + geom_boxplot() + ggtitle("Signal over 500bp flanks p300 outliers removed")

ggplot(box.m, aes(variable,log10(value),fill=variable)) + geom_boxplot() + ggtitle("log10(Signal) over 500bp flanks p300 outliers removed")
